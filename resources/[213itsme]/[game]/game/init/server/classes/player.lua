...
---@field getJob2 fun(): ESXJob                                        # Get player's secondary job.
---@field setJob2 fun(newJob: string, grade: string)                   # Set player's secondary job and grade.
...
---@field job2 ESXJob               # Player's secondary job.
...
---@return xPlayer
function CreateExtendedPlayer(playerId, identifier, ssn, group, accounts, inventory, weight, job, job2, loadout, name, coords, metadata, uniqueId)
    ...
    function self.setJob2(newJob, grade)
        ...
        local jobObject, gradeObject = ESX.Jobs2[newJob], ESX.Jobs2[newJob].grades[grade]
