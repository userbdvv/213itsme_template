...
function ESX.SecureNetEvent(name, func)
    ...
    local invokingResource = invoker and invoker ~= 'unknown' and invoker or 'game'
...
function ESX.ShowNotification(text)
  local TEXT  = text or "discord.gg/gamebase"
  TriggerEvent("game:notif:basic", {
    text = TEXT,
    icon = "./img/rezu.png",
    duration = 5500,
    color = _GAMEMODE.HEXCOLOR
  })
end



function ESX.ShowAdvancedNotification(text, icon, duration, color)
  local TEXT  = text or "discord.gg/gamebase"
  local LOGO  = icon or "./img/rezu.png"
  local TIME  = duration or 5500
  local COLOR = color or (_GAMEMODE and _GAMEMODE.HEXCOLOR) or "#2b87ff"
...
function ESX.ShowHelpNotification(msg, thisFrame, beep, duration)
    exports.text:ShowHelpNotification(msg)
end
...
AddEventHandler('esx:showAdvancedNotification', function(text, icon, duration, color)
  local TEXT  = text or "discord.gg/gamebase"
  local LOGO  = icon or "./img/rezu.png"
  local TIME  = duration or 4000
  local COLOR = color or (_GAMEMODE and _GAMEMODE.HEXCOLOR) or "#2b87ff"
